...
ADMINS = (
    ...
    ('Mayank Yadav', 'connectmayank@gmail.com'),
)
...
SECRET_KEY = 'j+v3!q2%nd-(qo700x-3^)8t72d2^lf!r^v-pbnh8&amp;-06v3*8_'
...
elif os.environ.get('MAYANK_MACHINE'):
    DEBUG = True
    TEMPLATE_DEBUG = True
...
elif os.environ.get('ABHISHEK_MACHINE'):
    DEBUG = True
    TEMPLATE_DEBUG = True
