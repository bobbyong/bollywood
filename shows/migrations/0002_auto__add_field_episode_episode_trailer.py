...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Episode.episode_trailer'
        db.add_column('shows_episode', 'episode_trailer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=11, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Episode.episode_trailer'
        db.delete_column('shows_episode', 'episode_trailer')
