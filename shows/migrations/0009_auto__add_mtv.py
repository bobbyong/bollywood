...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MTV'
        db.create_table('shows_mtv', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mtv_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('mtv_embed_code', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('shows', ['MTV'])


    def backwards(self, orm):
        # Deleting model 'MTV'
        db.delete_table('shows_mtv')
