...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Movie.movie_pix1'
        db.alter_column('shows_movie', 'movie_pix1', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Movie.movie_pix3'
        db.alter_column('shows_movie', 'movie_pix3', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Movie.movie_pix2'
        db.alter_column('shows_movie', 'movie_pix2', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Show.show_pix1'
        db.alter_column('shows_show', 'show_pix1', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Show.show_pix2'
        db.alter_column('shows_show', 'show_pix2', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Show.show_pix3'
        db.alter_column('shows_show', 'show_pix3', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Movie.movie_pix1'
        db.alter_column('shows_movie', 'movie_pix1', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Movie.movie_pix3'
        db.alter_column('shows_movie', 'movie_pix3', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Movie.movie_pix2'
        db.alter_column('shows_movie', 'movie_pix2', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Show.show_pix1'
        db.alter_column('shows_show', 'show_pix1', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Show.show_pix2'
        db.alter_column('shows_show', 'show_pix2', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Show.show_pix3'
        db.alter_column('shows_show', 'show_pix3', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
