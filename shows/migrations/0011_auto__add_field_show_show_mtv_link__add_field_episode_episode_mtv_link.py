...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Show.show_mtv_link'
        db.add_column('shows_show', 'show_mtv_link',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=6000, blank=True),
                      keep_default=False)

        # Adding field 'Episode.episode_mtv_link'
        db.add_column('shows_episode', 'episode_mtv_link',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=6000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Show.show_mtv_link'
        db.delete_column('shows_show', 'show_mtv_link')

        # Deleting field 'Episode.episode_mtv_link'
        db.delete_column('shows_episode', 'episode_mtv_link')
    ...
    models = {
        ...
        'shows.episode': {
            ...
            'episode_mtv_link': ('django.db.models.fields.TextField', [], {'max_length': '6000', 'blank': 'True'}),
        ...
        'shows.mtv': {
            'Meta': {'object_name': 'MTV'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mtv_embed_code': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'mtv_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'mtv_slug_name': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'})
        },
        'shows.network': {
        ...
        'shows.show': {
            ...
            'show_mtv_link': ('django.db.models.fields.TextField', [], {'max_length': '6000', 'blank': 'True'}),
