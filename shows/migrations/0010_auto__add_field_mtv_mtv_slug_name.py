...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MTV.mtv_slug_name'
        db.add_column('shows_mtv', 'mtv_slug_name',
                      self.gf('django.db.models.fields.SlugField')(default=9999, unique=True, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MTV.mtv_slug_name'
        db.delete_column('shows_mtv', 'mtv_slug_name')
